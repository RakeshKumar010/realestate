...
const Faqs = () => {
  return (
    <section className=" py-16 px-10   sm:py-16 lg:py-24">
        ...
        <div className="max-w-3xl mx-auto mt-8 space-y-4 md:mt-16">
            <div className="transition-all duration-200 bg-white border border-gray-200 shadow-lg cursor-pointer hover:bg-gray-50">
                <button type="button" className="flex items-center justify-between w-full px-4 py-5 sm:p-6">
                    <span className="flex text-lg font-semibold text-black"> What the First Step of Dream Apartment buying process ? </span>
                ...
                <div className="px-4 pb-5 sm:px-6 sm:pb-6">
                    <p>Amet minim mollit non deserunt ullamco est sit do amet sint. Velit officia consequat duis enim velit mollit.</p>
                </div>
            </div>
